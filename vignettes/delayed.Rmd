...
the [HPC Task
View](https://cran.r-project.org/web/views/HighPerformanceComputing.html) on
...
parallelize across the tasks, we leverage the excellent [`future`](https://github.com/HenrikBengtsson/future/) package [@futurePackage].
